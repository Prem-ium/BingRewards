...
## Installation
The bot can be run using Python or installed via Docker.
### Python Script
1. Clone this repository and install dependancies
```sh
...
`LOGIN` = A string of Bing Rewards login information. Email and Password are seperated using a colon and accounts are seperated using commas. Check the .env.example file for an example.
